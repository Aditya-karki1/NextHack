  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-white/10 backdrop-blur-md rounded-lg shadow-lg text-white">
        <h2 className="text-2xl font-bold mb-6 text-center">NGO Portal Registration</h2>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2 rounded-lg font-semibold bg-gray-200 text-gray-800 hover:bg-gray-300 mt-2"
          >
