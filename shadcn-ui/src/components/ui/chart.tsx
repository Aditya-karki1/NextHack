...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, any>((props, ref) => {
  ...
  const payload = Array.isArray(_payload) ? (_payload as any[]) : [];
...
const ChartLegendContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<'div'> &
    // Use a loose type for legend props from recharts to avoid property conflicts
    ({ payload?: any[]; verticalAlign?: 'top' | 'bottom' } & Record<string, any>) & {
      hideIcon?: boolean;
      nameKey?: string;
    }
